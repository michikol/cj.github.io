...
$APIKey = '9QZeg32KDGVW8tGIUDlYiQig';//百度AI开放平台数字识别API Key
$SecretKey = 'lMuSxjvZtOQ8wg3hUnBLye3Wyf1joru0';//百度AI开放平台数字识别API Key
...
while(! feof($file))
{
 $cjhaoma[$i]= fgets($file);
 $i++;
}
fclose($file);
$cjhaoma=array_filter($cjhaoma);
